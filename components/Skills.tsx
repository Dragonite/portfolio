...
const Skills = () => {
    ...
    return <div className='w-full text-center bg-zinc-950 grow pt-16 pb-8 rounded-2xl max-w-screen-xl mx-auto h-max mb-16'>
                ...
                <div className="flex flex-col pb-3">
                    ...
                    <dd className="flex flex-wrap w-4/5 justify-center mx-auto mt-2">
                        {languages.map(language => {
                            return <div key={language} className="w-max mx-1/2 my-1 bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">{language}</div>
                        })}
                    </dd>
                </div>

...
export default async function Home() {
  return (
    <main className="bg-zinc-900 relative flex min-h-screen w-full flex-col font-sans px-4 xl:px-8">
      <div className='w-full py-64 h-max text-center'>
        ...
        <h2 className='w-full mt-4 sm:mt-8'>
          <div className="m-0 inline-flex mx-auto font-mono text-xl sm:text-4xl">
            ...
            <div className="ml-2 -translate-y-1 animate-blink">_</div>
          </div>
        </h2>
        <div className='mt-8 flex justify-center gap-4'>
          <Link href="HaolinWuResume2023.pdf" target="_blank" download className="rounded-md bg-violet-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600">Resume</Link>
          <Link className="flex flex-col justify-center" href={urls.github}>
          ...
          <Link className="flex flex-col justify-center" href={urls.linkedIn}>
            <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-slate-200 hover:fill-slate-400"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
          </Link>
        </div>
      </div>

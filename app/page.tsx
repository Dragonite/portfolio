    ...
    <main className="bg-zinc-900 relative flex min-h-screen w-full flex-col font-sans px-4 xl:px-8">
      <div className='w-full py-64 h-max text-center'>
        ...
        <div className='mt-8 flex justify-center gap-4'>
          <Link href="HaolinWuResume2023.pdf" download className="rounded-md bg-violet-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600">Resume</Link>
